...
def calculateTotalTime():
      ...
      print("Continuous Winder: ", format_weight, "pounds of", wire_diameter, "inch diameter of ", density, "density wire at", RPM,"RPM will last for", format_hours, "hours")
